 ...
 * See {@link PathfinderDatabaseDataSet} for an overview over all tables.
 */
  public ComponentTable table_Component = new ComponentTable();
  ...
  public IDataSet createDBUnitDataSet()
  {
    ...
    try {
      ...
      dataSet.addTable(table_Component);
      table_Component.resetIterator();
  ...
  protected void prepareTables()
  {
    ...
    table_Component.setDataset(this);
  }
  ...
  */
  ...
  /** 
   * Adds the given row into the Table 'component'
   */
  public RowBuilder_Component add(RowBuilder_Component row) 
  {
    return table_Component.insertRow(row);
  }
  
  /** 
   * Adds the given row into the Table 'component'
   */
  public RowBuilder_Component add(ComponentModel row) 
  {
    return table_Component.insertRow(row);
  }
  /**
   * ! work in progress !
   * create a new Model of the Type ComponentModel with 
   * the same IdGenerator that this Dataset  
   */
  /*
