 ...
 * Available relations:
 * <ul>
 *   <li>{@link #componentto(ComponentRef ... )}</li>
 * </ul>
 */
public class ProjectRef extends DatabaseRef
{
  ...
  public void removeFromDataSet()
  {
    ...
    if (dataSet.table_Component.getWhere.projectId(this).isPresent())
    {
      dataSet.table_Component.findWhere.projectId(this).setProjectIdRaw(null);
    }
   ...
   */
  public ProjectRef componentto_projectIdTo(ComponentRef ... refs)
  {
    for (ComponentRef ref : refs)
    {
      ref.projectIdTo(this);
    }
    return this;
  }
